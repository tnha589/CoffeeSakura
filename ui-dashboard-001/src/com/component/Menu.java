...
public class Menu extends javax.swing.JPanel {
    ...
    private void init() {
       ...
       // listMenu1.addItem(new Model_Menu("", " ", Model_Menu.MenuType.EMPTY));
        listMenu1.addItem(new Model_Menu("menu", "Menu", Model_Menu.MenuType.MENU));
    //    listMenu1.addItem(new Model_Menu("", " ", Model_Menu.MenuType.EMPTY));
    ...
    //    listMenu1.addItem(new Model_Menu("", " ", Model_Menu.MenuType.EMPTY));
        listMenu1.addItem(new Model_Menu("khuyenmai", "Khuyến mãi", Model_Menu.MenuType.MENU));
   //     listMenu1.addItem(new Model_Menu("", " ", Model_Menu.MenuType.EMPTY));
//        listMenu1.addItem(new Model_Menu("", " ", Model_Menu.MenuType.EMPTY));
//
...
//        listMenu1.addItem(new Model_Menu("", " ", Model_Menu.MenuType.EMPTY));
 ...
 //       listMenu1.addItem(new Model_Menu("", " ", Model_Menu.MenuType.EMPTY));
        listMenu1.addItem(new Model_Menu("chitieu", "Chi tiêu", Model_Menu.MenuType.MENU));
 //       listMenu1.addItem(new Model_Menu("", " ", Model_Menu.MenuType.EMPTY));
...
//        listMenu1.addItem(new Model_Menu("", "", Model_Menu.MenuType.EMPTY));
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/icon/sakura2.png"))); // NOI18N
        jLabel1.setText("SAKURA COFFE");
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(15, 15, 15)
                .addComponent(listMenu1, javax.swing.GroupLayout.DEFAULT_SIZE, 449, Short.MAX_VALUE))
        );
    ...
    protected void paintChildren(Graphics grphcs) {
        ...
        GradientPaint g = new GradientPaint(0, 0, Color.decode("#D76067"), 0, getHeight(), Color.decode("#981D26"));
        g2.setPaint(g);

...
public class DangNhapTestNG extends javax.swing.JFrame {
    ...
    //Nhập dữ liệu tư
    public MainTestNG login(MainTestNG main) {
        ...
        if (nv == null) {
            ...
            XAuth.user = nv;
            this.dispose();
            main.setForm(main.home); // Hiển thị giao diện trang chủ
            return main;
        }
        return null;
    }
    ...
    public MainTestNG btnXacNhanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXacNhanActionPerformed
        // TODO add your handling code here:
        if (txtTenTK.getText().trim().length() > 0) {
        	if (txtPassword.getPassword().length > 0) {
                MainTestNG main = new MainTestNG();
                main = login(main);
                if(main != null) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DangNhapTestNG.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DangNhapTestNG().setVisible(true);
            }
        });
    }

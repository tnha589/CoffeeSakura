...
public class MainTestNG extends javax.swing.JFrame {
	...
	public MainTestNG() {
        ...
        home = new TrangChu();
        form1 = new Menu1();
        form2 = new HoaDon2TestNG();
        form3 = new QuanLySanPham1();
        form4 = new KhuyenMai1();
        try {
            form5 = new ThongKe1();
        } catch (ParseException ex) {
            Logger.getLogger(MainTestNG.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//        init();
        ...
        menu.initMoving(MainTestNG.this);
...
//        setForm(new TrangChu());
    ...
    public DangNhapTestNG openLogin() {
    	DangNhapTestNG login;
        login = new DangNhapTestNG();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MainTestNG.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MainTestNG().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    public HeaderTestNG header2;
